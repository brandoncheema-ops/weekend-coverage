...
def send_hr_log_email(new_entry):
    ...
    if not GMAIL_USER or not GMAIL_APP_PASSWORD:
        print("[HR EMAIL] Gmail credentials not set — skipping.")
        return
...
@app.route("/")
def index():
    """Home page — shows recent submissions."""
...
def weekend_coverage_form():
    """The form page — dates can be passed via query params or auto-calculated."""
...
# ---------------------------------------------------------------------------
# Scheduler — sends email every Monday at 8 AM Eastern
# ---------------------------------------------------------------------------
